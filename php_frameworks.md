...
* **Silex** — мікро-фреймворк на основі Symfony компонентів.
* **Slim** — мікро-фреймворк, який дозволяє швидко писати прості, але потужні веб-додатки і API.
* **Fat-Free Framework** — ще один достойний претендент.
