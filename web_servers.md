...
Apache — найбільш популярний веб-сервер у світі. Apache передусім використовується для передачі через HTTP статичних та динамічних веб-сторінок у всесвітній павутині.
