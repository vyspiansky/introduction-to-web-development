...
Такий підхід зручний тим, що спільні для декількох документів стилі можна винести в окремий файл і додавати їх за допомогою елементом link, не дублуючи один і тйо же CSS-код.
