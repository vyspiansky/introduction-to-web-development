...
Перехоплення виняткових ситуацій і помилок (англ. Catchable exceptions and errors)
...
Error hierarchy
Throwable
Error (arithmetic, assertion, parse, type)
Exception (logic, runtime)

Цілочисельне діленння (англ. Integer division with intdiv)

echo intdiv(5, 2); // 2

Функція особливо корисна для великих чисел.
Груповання оголошень use (англ. Grouped imports with use)
// PHP 5
...
Цим вписок нововведень не обмежується. За детальнішою інформацією зверніться на офіційний сайт php.net.
Застарілі або видалені фічі
Конструктори в дусі PHP 4 позначено як застарілі
Функції ereg_*, mysql_* та ряд інших були видалені
