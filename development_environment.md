...
Найпопулярнішим пакетом, мабуть, є [XAMPP](https://www.apachefriends.org/ru/index.html). XAMPP — повністю безкоштовний і простий в інсталяції дистрибутив Apache, що містить MariaDB (відгалуження MySQL), PHP (підтримує PHP 7) і Perl.
